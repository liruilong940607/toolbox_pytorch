...
def resnet50C4(pretrained=False, num_classes=None):
    ...
    if pretrained:
        pretrain_file = '/home/dalong/data/kaggle/ImageNet/pytorch_imagenet/basemodel/resnet50_from_modelzoo.pth'
...
def resnet101(pretrained=False, num_classes=None):
    ...
    if pretrained:
        pretrain_file = '/home/dalong/data/kaggle/ImageNet/pytorch_imagenet/basemodel/resnet101_from_modelzoo.pth'
        if not os.path.exists(pretrain_file):
